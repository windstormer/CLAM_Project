...
if [ -n "$1" ]; then
    if [ "$1" == "t1" ]; then
        ...
        # python3 main.py --classifier_path CNet_t2_ep30_b32.{UNet_None} -m t2 -c CLAM
        python3 main.py --classifier_path CNet_t2_ep30_b32.{UNet_t2_ep100_b64}.finetuned -m t2 -c CLAM
    elif [ "$1" == "t1ce" ]; then
        python3 main.py --classifier_path CNet_t1ce_ep30_b32.{UNet_t1ce_ep100_b64}.finetuned -m t1ce -c CLAM
    else
