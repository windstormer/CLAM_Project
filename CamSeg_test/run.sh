...
# python3 main.py --classifier_path CNet_t1_ep30_b256.{SSL_t1_ep250_b512}.finetuned -m t1 -c ScoreCAM
# python3 main.py --classifier_path CNet_t1_ep30_b256.{SSL_t1_ep250_b512}.finetuned -m t1 -c CLAM
python3 main.py --classifier_path CNet_t1_ep30_b256.{SSL_t1_ep250_b512}.finetuned -m t1 -c CLAMACC
...
python3 main.py --classifier_path CNet_t1_ep30_b32.{UNet_t1_ep250_b32}.finetuned -m t1 -c CLAMACC
...
python3 main.py --classifier_path CNet_t1_ep30_b32.{DLab_t1_ep65_b32}.finetuned -m t1 -c CLAMACC